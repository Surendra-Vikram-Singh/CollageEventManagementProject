...
<header>
<h1 style="color:red; text-align:center; padding-top:50px;"><I>dear <?php echo $adname.", " ?>here you can post images, vedios and photos of various events<I></h1>
...
<form action="uploadnotice.php" method="post" enctype="multipart/form-data" >
 ...
 <input type="file" name="file" id="fileToUpload">
  ...
  <tr>
  <td>
  <input type="submit" value="Upload Notice" name="btn-upload">
  </td></tr>
  </table>
</form>
...
<form action="uploadvideo.php" method="post" enctype="multipart/form-data" >
 ...
 <input type="file" name="file" >
  ...
  <tr>
  <td>
  <input type="submit" value="Upload Video" name="btn-upload">
  </td></tr>
  </table>
</form>
</section>
