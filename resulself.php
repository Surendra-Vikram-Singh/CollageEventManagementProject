...
<header>
<h1 style="color:red; text-align:center; padding:4%"><I>Hai <?php echo $na.", "; ?>here you view the result of your participations <I></h1>
...
$sql = "SELECT * FROM `result` WHERE email='$em';";
