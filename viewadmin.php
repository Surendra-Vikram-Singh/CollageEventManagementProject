...
<header>
<h1 style="color:red; text-align:center; padding:4%"><I>dear<?php echo" $adname, ";?> here you view the list of various events posted by you<I></h1>
...
<section>
<h2 align="center">EVENTS DATA</b></h2>
<!-- <select name="collage" id="collage" ALIGN="center">
      <option>  Select by organiser </option>
      <option value=""></option>
</select> -->
